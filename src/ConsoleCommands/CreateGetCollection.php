...
#[Service]
readonly class CreateGetCollection extends BaseConsoleCommand
{
    ...
    {
        return 'Creates a GET collection method for a given entity class';
    }
